...
task.list (adapter: github, repo: "owner/repo")

# Create an issue
task.create (adapter: github, repo: "owner/repo", title: "Fix bug", description: "Details...")

# Close an issue
task.complete (adapter: github, repo: "owner/repo", id: "123")
```
...
```bash
# List your gists
post.list (adapter: github)

# Create a gist
post.create (adapter: github, content: "# My Gist", title: "Description")
```
...
```bash
# Browse repo root
file.list (adapter: github, path: "owner/repo")

# Read a file
file.read (adapter: github, path: "owner/repo/README.md")

# Read from branch
file.read (adapter: github, path: "owner/repo/config.json", ref: "develop")
```
