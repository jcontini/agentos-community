 ...
 * 
 * Comprehensive tests for the Todoist adapter using API v1.
...
describe('Todoist Adapter', () => {
  ...
  // ===========================================================================
  // Priority (AgentOS scale: 1=highest/urgent, 4=lowest/normal)
  // ===========================================================================
  describe('priority', () => {
    it('can create task with priority 1 (highest/urgent)', async () => {
      if (skipTests) return;
    ...
    it('can create task with priority 4 (lowest/normal)', async () => {
      if (skipTests) return;
  ...
  describe('project.list', () => {
    it('returns an array of projects with all fields', async () => {
      ...
      for (const project of projects) {
        ...
        expect(project.adapter).toBe(adapter);
        // Optional fields
  ...
  describe('label.list', () => {
    it('returns an array of labels with all fields', async () => {
      ...
      for (const label of labels) {
        ...
        expect(label.adapter).toBe(adapter);
        // Optional fields
  ...
  describe('complex scenarios', () => {
    it('full task lifecycle with all fields', async () => {
      ...
      expect(created._labels).toContain('test-full');
