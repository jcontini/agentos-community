...
| `models/` | Entity schemas + views + components (apps spawn from these at runtime) |
...
- [ ] Mapping covers entity properties (check `models/{domain}/models.yaml`)
...
| `models/{domain}/models.yaml` | Entity schema — what properties to map |
