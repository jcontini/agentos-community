...
- **Layer 2: Discovery** — [2-discovery](../2-discovery/index.html) — finding structured data in pages and bundles
- **Layer 3: Auth & Runtime** — [3-auth](../3-auth/index.html) — credentials, sessions, rotating config
- **Layer 4: Content** — [4-content](../4-content/index.html) — extracting data from HTML when there is no API
...
- **Layer 7: MCP Servers** — [7-mcp](../7-mcp/index.html) — discovering, probing, and evaluating remote/stdio MCPs
